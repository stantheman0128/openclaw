...
export const ar: TranslationMap = {
  ...
  modelSetup: {
    ...
    empty: {
      ...
      intro: "لم يتم اكتشاف وصول حالي إلى الذكاء الاصطناعي. ثبّت إحدى هذه الأدوات ثم تحقق مرة أخرى.",
    },
    unavailable: {
  ...
  activity: {
    ...
    answerCandidate: {
      title: "إجابة مرشحة",
      itemId: "عنصر",
      candidate: "الإجابة المرشحة",
      superseded: "الإجابة المستبدلة",
  ...
  workspaces: {
    ...
    widget: {
      ...
      agentStatus: {
        empty: "لا توجد وكلاء أو جلسات بعد.",
        busy: "مشغول",
        idle: "خامل",
      ...
      customWidgetApprovals: {
        ...
        approve: "موافقة",
        reject: "رفض",
        permissionRequired: "إذن الموافقة مطلوب",
      },
      usage: {
        cost: "Cost",
        tokens: "Tokens",
  ...
  chat: {
    ...
    composer: {
      ...
      startVideoTalk: "بدء محادثة فيديو",
