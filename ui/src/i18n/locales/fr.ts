...
export const fr: TranslationMap = {
  ...
  modelSetup: {
    ...
    empty: {
      ...
      intro:
        "Aucun accès IA existant n'a été détecté. Installez l'un de ces outils, puis vérifiez à nouveau.",
    },
    unavailable: {
  ...
  workspaces: {
    ...
    widget: {
      ...
      agentStatus: {
        empty: "Aucun agent ni session pour l'instant.",
        busy: "Occupé",
        idle: "Inactive",
        progress: "{percent}% terminé",
      },
      customWidgetApprovals: {
        empty: "Aucun widget personnalisé en attente d'approbation.",
      ...
      preview: {
        missing: "Cet aperçu n’a pas encore d’URL.",
        blockedExternal: "Les aperçus externes sont désactivés par la politique de votre Gateway.",
        blockedScheme: "L’URL de cet aperçu utilise un schéma non pris en charge.",
        toolbar: "Commandes de l’aperçu",
        reload: "Recharger l’aperçu",
        viewport: {
          label: "Fenêtre d’affichage de l’aperçu",
          desktop: "Ordinateur",
          tablet: "Tablette",
          mobile: "Mobile",
        },
  ...
  chat: {
    ...
    composer: {
      ...
      startVideoTalk: "Démarrer une conversation vidéo",
