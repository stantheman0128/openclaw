...
export const pt_BR: TranslationMap = {
  ...
  modelSetup: {
    ...
    empty: {
      ...
      intro:
        "Nenhum acesso a IA existente foi detectado. Instale uma dessas ferramentas e verifique novamente.",
    },
    unavailable: {
  ...
  workspaces: {
    ...
    widget: {
      ...
      agentStatus: {
        empty: "Nenhum agente ou sessão ainda.",
        busy: "Ocupado",
        idle: "Ociosa",
        progress: "{percent}% concluído",
      },
      customWidgetApprovals: {
        empty: "Nenhum widget personalizado aguardando aprovação.",
        kind: "Widget personalizado",
        requestedBy: "Solicitado por {agent}",
        approve: "Aprovar",
        reject: "Rejeitar",
        permissionRequired: "Permissão de aprovação necessária",
      },
      usage: {
        cost: "Cost",
        tokens: "Tokens",
  ...
  chat: {
    ...
    questions: {
      title: "O Codex precisa de dados",
    ...
    composer: {
      ...
      startVideoTalk: "Iniciar conversa em vídeo",
