...
export const th: TranslationMap = {
  ...
  workspaces: {
    ...
    widget: {
      ...
      agentStatus: {
        empty: "ยังไม่มี agent หรือเซสชัน",
        busy: "ไม่ว่าง",
        idle: "ไม่ได้ใช้งาน",
        progress: "เสร็จแล้ว {percent}%",
      },
      customWidgetApprovals: {
        empty: "ไม่มีวิดเจ็ตกำหนดเองที่รอการอนุมัติ",
        kind: "วิดเจ็ตกำหนดเอง",
  ...
  chat: {
    ...
    questions: {
      title: "Codex ต้องการข้อมูลป้อนเข้า",
    ...
    composer: {
      ...
      startVideoTalk: "เริ่มการสนทนาวิดีโอ",
